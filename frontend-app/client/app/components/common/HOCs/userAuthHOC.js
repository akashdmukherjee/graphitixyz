/**
 * authHOC makes sure that loggedInUser details,
...
const userAuthHOC = (Component, checkAssetPermissions) => {
  class WrappedComponent extends React.Component {
    ...
    render() {
      ...
      if (checkAssetPermissions) {
        newProps.assetUserAccessibility = assetUserAccessibility;
      }
      if (loggedInUser && assetDetails) {
        if (checkAssetPermissions && assetUserAccessibility) {
          return <Component {...newProps} />;
        } else if (!checkAssetPermissions) {
          return <Component {...newProps} />;
        }
      }
