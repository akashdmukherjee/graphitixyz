...
public class Oracle implements Database{
	...
	@Override
	public Object getConnection(com.graphiti.bean.Connection connection)
			throws ClassNotFoundException, SQLException {
		String connectionURL = "jdbc:oracle:thin:@"+connection.getServerUrl()+":"+connection.getPort()+":"+connection.getDatabaseName();
        // TODO - SSL 
