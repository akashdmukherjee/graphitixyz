...
public class AssetUsers {
	...
	// Endorsements
	private List<AssetUsersInfo> trusted;
	private List<AssetUsersInfo> erroneous;
	private List<AssetUsersInfo> deprecated;
	...
	public AssetUsers(String name,AssetType t,AssetUsersInfo creator,String orgId){
		...
		faqs = new ArrayList<>(1);
		trusted = new ArrayList<>(1);
		erroneous = new ArrayList<>(1);
		deprecated = new ArrayList<>(1);
		this.orgId = orgId;
	}
	...
	public List<AssetUsersInfo> getTrusted() {
		return trusted;
	}

	public void setTrusted(List<AssetUsersInfo> trusted) {
		this.trusted = trusted;
	}

	public List<AssetUsersInfo> getErroneous() {
		return erroneous;
	}

	public void setErroneous(List<AssetUsersInfo> erroneous) {
		this.erroneous = erroneous;
	}

	public List<AssetUsersInfo> getDeprecated() {
		return deprecated;
	}

	public void setDeprecated(List<AssetUsersInfo> deprecated) {
